var TextRu='Где все люди!!!?...';
  
  var TextEng='Where are all the people!!!?...';
  ...
  tab.className = "tab"; 
  if (language==1){
    tab.innerHTML=  Ru + '<br><button onclick="closeTab(), ambient3.play()">ok</button>' 
  }else
     {tab.innerHTML= Eng + '<br><button onclick="closeTab(), ambient3.play()">ok</button>' };
