var bot4LeftXDistance=-20;
var bot4RightXDistance=20;
var bot4UpYDistance=20;
var bot4DownYDistance=-20;
var temp2;
var vertical2;
var rand2;
var botLife2=200;
...
enemy2.moveRight=function(distance) {
  ...
  this.style.backgroundImage='URL("IMG/monsterBlob_r.gif")';
if (rightTemp==1) {
...
enemy2.moveLeft=function(distance) {
  var m2 = enemy2.getBoundingClientRect();
  bot_get_coordinates(m2);
  this.style.backgroundImage='URL("IMG/monsterBlob_l.gif")';
if (leftTemp==1) {
  temp2=temp2+distance;
  this.style.left = temp2 + 'px';
  this.innerHTML=botLife2;
 ...
 if( ( (p.bottom-m2.bottom)<=50 && (p.bottom-m2.bottom)>=-50 ) && ( (p.right-m2.right)<=50 && (p.right-m2.right)>=-50 )) {
  ...
  monsterAttack.play();
    ...
    if(p.right-m2.right<200 && p.right-m2.right>0){
      enemy2.moveRight(bot4RightXDistance);
    }
    
     if(p.right-m2.right>-200 && p.right-m2.right<0){
      enemy2.moveLeft(bot4LeftXDistance);
    }
    
      if(p.bottom-m2.bottom<200 && p.bottom-m2.bottom>0){
      enemy2.moveDown(bot4DownYDistance);
    }
    
     if(p.bottom-m2.bottom>-200 && p.bottom-m2.bottom<0){
      enemy2.moveUp(bot4UpYDistance);
    }
